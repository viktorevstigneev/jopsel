...
import { S as Stringable, F as FormattableString } from './formattable-string-BKevNsLk.cjs';
export { g as getFormattable } from './formattable-string-BKevNsLk.cjs';
 ...
 */
declare const bold: {
    (str: Stringable | null | undefined): FormattableString;
    (strings: TemplateStringsArray, ...values: (Stringable | null | undefined)[]): FormattableString;
};
/**
 ...
 */
declare const pre: (str: Stringable | null | undefined, language?: string | undefined) => FormattableString;
/**
 ...
 */
declare const link: (str: Stringable | null | undefined, url: string) => FormattableString;
/**
 ...
 */
declare const mention: (str: Stringable | null | undefined, user: TelegramUser) => FormattableString;
/**
 ...
 * ```
 */
declare function join(array: (Stringable | false | undefined | null)[], separator?: string): FormattableString;
 ...
 */
declare function format(stringParts: TemplateStringsArray, ...strings: (Stringable | undefined | null)[]): FormattableString;
/**
 * [Template literal](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals)
 * that helps construct message [entities](https://core.telegram.org/bots/api#messageentity) for text formatting.
 *
 ...
 */
declare function formatSaveIndents(stringParts: TemplateStringsArray, ...strings: (Stringable | undefined | null)[]): FormattableString;
