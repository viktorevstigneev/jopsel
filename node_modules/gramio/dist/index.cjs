...
class Updates {
  ...
  constructor(bot, onError) {
    ...
    this.queue = new composer.EventQueue(this.handleUpdate.bind(this));
  }
...
class Bot {
  ...
  async init() {
    ...
    if (!this.info) {
      ...
      this.info = info;
      this.updates.composer.info = this.info;
    }
  }
  /**
...
Object.defineProperty(exports, "noopNext", {
	enumerable: true,
	get: function () { return composer.noopNext; }
});
Object.defineProperty(exports, "skip", {
	enumerable: true,
	get: function () { return composer.skip; }
});
